...
<div class="page-content container container-plus">
	...
	<div class="card-body px-3 pb-1">
		<form class="mt-lg-3" autocomplete="off" method="post" action="{{route('pelanggan.update', $pelanggan->IdPelanggan)}}">
	    @csrf
		<div class="form-group row">
			...
			<div class="col-sm-9">
			 	<input type="text" class="form-control col-sm-8 col-md-6" id="name" name="name" value="{{$pelanggan->NamaPelanggan}}" required="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="col-sm-9">
			 	<input type="text" class="form-control col-sm-8 col-md-6" id="alamat" name="alamat" value="{{$pelanggan->Alamat}}" required="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="col-sm-9">
			 	<input type="text" class="form-control col-sm-8 col-md-6" id="notelp" name="notelp" value="{{$pelanggan->NoTelp}}" required="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
