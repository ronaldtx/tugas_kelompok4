...
<div class="page-content container container-plus">
	...
	<div class="card-body px-3 pb-1">
		<form class="mt-lg-3" autocomplete="off" method="post" action="{{route('pembelian.destroy', $pembelian->IdPembelian)}}">
	    @csrf
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
			 	<input type="number" class="form-control col-sm-8 col-md-6" id="jumlah" value="{{$pembelian->JumlahPembelian}}" name="jumlah" disabled="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="col-sm-9">
			 	<input type="number" class="form-control col-sm-8 col-md-6" id="harga" value="{{$pembelian->HargaBeli}}" name="harga" disabled="true" />
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
			 	<select class="form-control col-sm-8 col-md-6" id="supplier" name="supplier" disabled="true">
