...
<div class="page-content container container-plus">
	...
	<div class="card-body px-3 pb-1">
		<form class="mt-lg-3" autocomplete="off" method="post" action="{{route('pengguna.store')}}">
	    @csrf
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
			 	<input type="text" class="form-control col-sm-8 col-md-6" id="depan" name="depan" required="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="col-sm-9">
			 	<input type="text" class="form-control col-sm-8 col-md-6" id="belakang" name="belakang" required="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="col-sm-9">
			 	<input type="text" class="form-control col-sm-8 col-md-6" id="alamat" name="alamat" required="true" />
			</div>
		</div>
		<div class="form-group row">
			<div class="col-sm-3 col-form-label text-sm-right pr-0">
			...
			<div class="col-sm-9">
			 	<select class="form-control col-sm-8 col-md-6" id="hakakses" name="hakakses" required="true">
			 		...
			 		<option value="{{$akses->IdAkses}}"{{$key==0?' selected':''}}>{{$akses->NamaAkses}}</option>
			 		@endforeach
			 	</select>
			</div>
		</div>
